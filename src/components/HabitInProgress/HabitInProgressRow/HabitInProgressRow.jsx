      ...
      <div className="HabitInProgressRow">
        {isLastDayOfHabit ? (
            ...
            <div className="table-data progress">
              {isStartAgain ? (
                ...
                <h3>
                  ...
                  <span className="text">times in</span>{' '}
                  <span className="table-data--important">
                    {AMOUNT_OF_DAYS}
                  </span>{' '}
                  days.
                </h3>
          ...
          <>
            ...
            <div className="table-data">
              <span className="important">{myProgress}</span>
              <span className="important">/{AMOUNT_OF_DAYS}</span>
            </div>
          </>
        )}
      </div>
